...
var AdvancedSearchInputSet = function() {
    AdvancedSearchInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the SearchValue input for this Choreo. ((conditional, string) Indicate the product, code, or sector to search for. Used together with SearchType and the optional Operator input to create a customized search.)
        */
