...
var PostInputSet = function() {
    PostInputSet.super_.call(this);
        /*
        Set the value of the EncodedData input for this Choreo. ((optional, multiline) The Base64 encoded content of a file that should be specified as the request body. This input should be used instead of the RequestBody input when posting binary data.)
        */
        this.set_EncodedData = function(value) {
            this.setInput("EncodedData", value);
        }

        /*
        Set the value of the RequestBody input for this Choreo. ((optional, multiline) The request body for the POST. This input is used when the request body is text e.g. application/json, application/xml, plain/text, etc. Use the EncodedData input when posting binary.)
        */
