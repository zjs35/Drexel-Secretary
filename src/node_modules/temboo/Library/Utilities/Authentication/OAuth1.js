...
var FinalizeOAuth = function(session) {
	...
	*/
    var location = "/Library/Utilities/Authentication/OAuth1/FinalizeOAuth"
...
var FinalizeOAuthInputSet = function() {
    FinalizeOAuthInputSet.super_.call(this);
        ...
        */
        this.set_AccessTokenURL = function(value) {
            this.setInput("AccessTokenURL", value);
        }
...
var InitializeOAuth = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Utilities/Authentication/OAuth1/InitializeOAuth"
...
var InitializeOAuthInputSet = function() {
    InitializeOAuthInputSet.super_.call(this);
        ...
        */
        this.set_AuthorizationEndpoint = function(value) {
            this.setInput("AuthorizationEndpoint", value);
        }
