...
var CreateInvoiceItemInputSet = function() {
    CreateInvoiceItemInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Invoice input for this Choreo. ((optional, string) The ID of an existing invoice to add this invoice item to.)
        */
        this.set_Invoice = function(value) {
            this.setInput("Invoice", value);
        }
...
var ListAllInvoiceItemsInputSet = function() {
    ListAllInvoiceItemsInputSet.super_.call(this);
        ...
        */
        this.set_Expand = function(value) {
            this.setInput("Expand", value);
        }
