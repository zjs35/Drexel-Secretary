...
var GetReviewerInputSet = function() {
    GetReviewerInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the ResourceType input for this Choreo. ((optional, string) Specify "all", "full-time", or "part-time" for that subset. Specify a reviewer's name to get details about a reviewer (e.g. Manohla Dargis).)
        */
        this.set_ResourceType = function(value) {
            this.setInput("ResourceType", value);
        }
...
var SearchByKeywordInputSet = function() {
    SearchByKeywordInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Reviewer input for this Choreo. ((optional, string) Limits results to reviews by a specific critic.)
        */
