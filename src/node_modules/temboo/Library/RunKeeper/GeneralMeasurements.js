...
/*
    RetrieveLatestEntry
    Returns the latest entry from a user's general body measurements history.
*/
...
var RetrieveLatestEntry = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/RunKeeper/GeneralMeasurements/RetrieveLatestEntry"
...
var RetrieveLatestEntryResultSet = function(resultStream) {
    RetrieveLatestEntryResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Timestamp" output from this Choreo execution. ((date) The timestamp for the entry.)
        */
        this.get_Timestamp = function() {
            return this.getResult("Timestamp");
        }
        /*
        Retrieve the value for the "TotalCholesterol" output from this Choreo execution. ((decimal) The value of the measured quantity in mg/dL (omitted if not available).)
        */
        this.get_TotalCholesterol = function() {
            return this.getResult("TotalCholesterol");
        }
        /*
