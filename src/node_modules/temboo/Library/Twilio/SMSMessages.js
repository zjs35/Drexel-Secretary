...
var GetLastMessageThatContainsInputSet = function() {
    GetLastMessageThatContainsInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the AfterSID input for this Choreo. ((optional, string) Returns messages after the specified message sid. Required when using the pagination parameters. To return message sids in the response, set ResponseMode to "verbose".)
        */
        this.set_AfterSID = function(value) {
            this.setInput("AfterSID", value);
        }
...
var GetLastMessageThatContainsResultSet = function(resultStream) {
    GetLastMessageThatContainsResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "TotalPages" output from this Choreo execution. ((integer) Deprecated (retained for backward compatibility only).)
        */
...
var SendSMSInputSet = function() {
    SendSMSInputSet.super_.call(this);
        ...
        */
        this.set_MediaURL = function(value) {
