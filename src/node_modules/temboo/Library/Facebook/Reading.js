...
var AccountsInputSet = function() {
    AccountsInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the ProfileID input for this Choreo. ((optional, string) The id of the user to retrieve account info for. Defaults to "me" indicating the authenticated user.)
        */
...
var CommentsInputSet = function() {
    CommentsInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Summary input for this Choreo. ((optional, boolean) Shows a summary of metadata about the comments on the object. This metadata includes order which indicates how the comments are being sorted.)
        */
...
var FriendLists = function(session) {
    /*
        Create a new instance of the FriendLists Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Reading/FriendLists"
    FriendLists.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new FriendListsResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new FriendListsInputSet();
    }
...
var FriendListsInputSet = function() {
    FriendListsInputSet.super_.call(this);
        /*
...
var FriendListsResultSet = function(resultStream) {
    FriendListsResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "HasNext" output from this Choreo execution. ((boolean) A boolean flag indicating that a next page exists.)
        */
        this.get_HasNext = function() {
...
util.inherits(FriendLists, choreography.Choreography);
util.inherits(FriendListsInputSet, choreography.InputSet);
util.inherits(FriendListsResultSet, choreography.ResultSet);
exports.FriendLists = FriendLists;
...
var FriendshipExists = function(session) {
    /*
        Create a new instance of the FriendshipExists Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Reading/FriendshipExists"
    FriendshipExists.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new FriendshipExistsResultSet(resultStream);
    }
...
var FriendshipExistsInputSet = function() {
    FriendshipExistsInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final OAuth step.)
        */
        this.set_AccessToken = function(value) {
...
var FriendshipExistsResultSet = function(resultStream) {
    FriendshipExistsResultSet.super_.call(this, resultStream);    
        /*
        ...
        */
        this.get_IsFriend = function() {
            return this.getResult("IsFriend");
        }
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Facebook. Corresponds to the ResponseFormat input. Defaults to JSON.)
        */
...
util.inherits(FriendshipExists, choreography.Choreography);
util.inherits(FriendshipExistsInputSet, choreography.InputSet);
util.inherits(FriendshipExistsResultSet, choreography.ResultSet);
exports.FriendshipExists = FriendshipExists;
...
var LikesPage = function(session) {
    /*
        Create a new instance of the LikesPage Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Reading/LikesPage"
    LikesPage.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new LikesPageResultSet(resultStream);
    }
...
/*
An InputSet with methods appropriate for specifying the inputs to the LikesPage
Choreo. The InputSet object is used to specify input parameters when executing this Choreo.
*/

var LikesPageInputSet = function() {
    LikesPageInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final OAuth step.)
        */
        this.set_AccessToken = function(value) {
        ...
        */
        this.set_PageID = function(value) {
            this.setInput("PageID", value);
        }
...
var LikesPageResultSet = function(resultStream) {
    LikesPageResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(LikesPage, choreography.Choreography);
util.inherits(LikesPageInputSet, choreography.InputSet);
util.inherits(LikesPageResultSet, choreography.ResultSet);
exports.LikesPage = LikesPage;
...
var Paginate = function(session) {
    /*
        Create a new instance of the Paginate Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Reading/Paginate"
    Paginate.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new PaginateResultSet(resultStream);
    }
...
var PaginateInputSet = function() {
    PaginateInputSet.super_.call(this);
        /*
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        */
        this.set_ResponseFormat = function(value) {
...
var PaginateResultSet = function(resultStream) {
    PaginateResultSet.super_.call(this, resultStream);    
        /*
...
util.inherits(Paginate, choreography.Choreography);
util.inherits(PaginateInputSet, choreography.InputSet);
util.inherits(PaginateResultSet, choreography.ResultSet);
...
var PictureInputSet = function() {
    PictureInputSet.super_.call(this);
        ...
        */
        this.set_Redirect = function(value) {
...
var ProfileFeedInputSet = function() {
    ProfileFeedInputSet.super_.call(this);
        ...
        */
        this.set_With = function(value) {
            this.setInput("With", value);
        }
...
var TaggableFriends = function(session) {
    /*
        Create a new instance of the TaggableFriends Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Reading/TaggableFriends"
    TaggableFriends.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new TaggableFriendsResultSet(resultStream);
    }
...
var TaggableFriendsInputSet = function() {
    TaggableFriendsInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var TaggableFriendsResultSet = function(resultStream) {
    TaggableFriendsResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "HasNext" output from this Choreo execution. ((boolean) A boolean flag indicating that a next page exists.)
        */
        this.get_HasNext = function() {
...
util.inherits(TaggableFriends, choreography.Choreography);
util.inherits(TaggableFriendsInputSet, choreography.InputSet);
util.inherits(TaggableFriendsResultSet, choreography.ResultSet);
exports.TaggableFriends = TaggableFriends;
...
var TaggedPlaces = function(session) {
    /*
        Create a new instance of the TaggedPlaces Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Facebook/Reading/TaggedPlaces"
    TaggedPlaces.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new TaggedPlacesResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new TaggedPlacesInputSet();
    }
...
var TaggedPlacesInputSet = function() {
    TaggedPlacesInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The access token retrieved from the final step of the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var TaggedPlacesResultSet = function(resultStream) {
    TaggedPlacesResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "HasNext" output from this Choreo execution. ((boolean) A boolean flag indicating that a next page exists.)
        */
        this.get_HasNext = function() {
...
util.inherits(TaggedPlaces, choreography.Choreography);
util.inherits(TaggedPlacesInputSet, choreography.InputSet);
util.inherits(TaggedPlacesResultSet, choreography.ResultSet);
exports.TaggedPlaces = TaggedPlaces;
