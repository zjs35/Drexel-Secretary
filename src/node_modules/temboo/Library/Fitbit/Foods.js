...
var GetFood = function(session) {
    /*
        Create a new instance of the GetFood Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Fitbit/Foods/GetFood"
    GetFood.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new GetFoodResultSet(resultStream);
    }
...
var GetFoodInputSet = function() {
    GetFoodInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token retrieved during the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var GetFoodResultSet = function(resultStream) {
    GetFoodResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Fitbit.)
        */
        this.get_Response = function() {
...
util.inherits(GetFood, choreography.Choreography);
util.inherits(GetFoodInputSet, choreography.InputSet);
util.inherits(GetFoodResultSet, choreography.ResultSet);
...
var GetFoodUnitsInputSet = function() {
    GetFoodUnitsInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the AccessTokenSecret input for this Choreo. ((optional, string) Deprecated (retained for backward compatibility only).)
        */
        this.set_AccessTokenSecret = function(value) {
            this.setInput("AccessTokenSecret", value);
        }
...
var GetLatestFood = function(session) {
    /*
        Create a new instance of the GetLatestFood Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Fitbit/Foods/GetLatestFood"
    GetLatestFood.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new GetLatestFoodResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new GetLatestFoodInputSet();
    }
...
var GetLatestFoodInputSet = function() {
    GetLatestFoodInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token retrieved during the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var GetLatestFoodResultSet = function(resultStream) {
    GetLatestFoodResultSet.super_.call(this, resultStream);    
        /*
        ...
        */
        this.get_DateLastEaten = function() {
            return this.getResult("DateLastEaten");
        }
        /*
        Retrieve the value for the "FoodID" output from this Choreo execution. ((string) The ID of the food.)
        */
        this.get_FoodID = function() {
            return this.getResult("FoodID");
        }
        /*
...
util.inherits(GetLatestFood, choreography.Choreography);
util.inherits(GetLatestFoodInputSet, choreography.InputSet);
util.inherits(GetLatestFoodResultSet, choreography.ResultSet);
...
var GetWaterGoal = function(session) {
    /*
        Create a new instance of the GetWaterGoal Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Fitbit/Foods/GetWaterGoal"
    GetWaterGoal.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new GetWaterGoalResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new GetWaterGoalInputSet();
    }
...
var GetWaterGoalInputSet = function() {
    GetWaterGoalInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token retrieved during the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var GetWaterGoalResultSet = function(resultStream) {
    GetWaterGoalResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Fitbit.)
        */
        this.get_Response = function() {
...
util.inherits(GetWaterGoal, choreography.Choreography);
util.inherits(GetWaterGoalInputSet, choreography.InputSet);
util.inherits(GetWaterGoalResultSet, choreography.ResultSet);
exports.GetWaterGoal = GetWaterGoal;
...
var UpdateWaterGoal = function(session) {
    /*
        Create a new instance of the UpdateWaterGoal Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Fitbit/Foods/UpdateWaterGoal"
    UpdateWaterGoal.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new UpdateWaterGoalResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new UpdateWaterGoalInputSet();
    }
...
var UpdateWaterGoalInputSet = function() {
    UpdateWaterGoalInputSet.super_.call(this);
        /*
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token retrieved during the OAuth process.)
        */
        this.set_AccessToken = function(value) {
...
var UpdateWaterGoalResultSet = function(resultStream) {
    UpdateWaterGoalResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Fitbit.)
        */
        this.get_Response = function() {
...
util.inherits(UpdateWaterGoal, choreography.Choreography);
util.inherits(UpdateWaterGoalInputSet, choreography.InputSet);
util.inherits(UpdateWaterGoalResultSet, choreography.ResultSet);
exports.UpdateWaterGoal = UpdateWaterGoal;
