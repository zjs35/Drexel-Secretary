...
var GetLatestUnreadEmail = function(session) {
    /*
        Create a new instance of the GetLatestUnreadEmail Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Google/Gmail/GetLatestUnreadEmail"
    GetLatestUnreadEmail.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new GetLatestUnreadEmailResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new GetLatestUnreadEmailInputSet();
    }
...
var GetLatestUnreadEmailInputSet = function() {
    GetLatestUnreadEmailInputSet.super_.call(this);
        /*
...
var GetLatestUnreadEmailResultSet = function(resultStream) {
    GetLatestUnreadEmailResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "AuthorEmail" output from this Choreo execution. ((string) The author's email address.)
        */
        this.get_AuthorEmail = function() {
            return this.getResult("AuthorEmail");
        }
        /*
        Retrieve the value for the "AuthorName" output from this Choreo execution. ((string) The author's name.)
        */
        this.get_AuthorName = function() {
            return this.getResult("AuthorName");
        }
        /*
        ...
        */
        this.get_MessageBody = function() {
            return this.getResult("MessageBody");
        }
        /*
...
util.inherits(GetLatestUnreadEmail, choreography.Choreography);
util.inherits(GetLatestUnreadEmailInputSet, choreography.InputSet);
util.inherits(GetLatestUnreadEmailResultSet, choreography.ResultSet);
exports.GetLatestUnreadEmail = GetLatestUnreadEmail;
...
var SendEmailInputSet = function() {
    SendEmailInputSet.super_.call(this);
        ...
        */
        this.set_TLS = function(value) {
            this.setInput("TLS", value);
        }
