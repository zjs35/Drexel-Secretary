...
var GetAllCalendarsInputSet = function() {
    GetAllCalendarsInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Count input for this Choreo. ((optional, integer) Deprecated (retained for backward compatibility only).)
        */
        ...
        */
        ...
        /*
        Set the value of the MaxResults input for this Choreo. ((optional, integer) The maximum number of results to return on one result page.)
        */
        ...
        /*
        Set the value of the PageToken input for this Choreo. ((optional, string) Token specifying which result page to return.)
        */
...
var GetAllEventsInputSet = function() {
    GetAllEventsInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the CalendarID input for this Choreo. ((required, string) The unique ID for the calendar with the events to retrieve. Note that calendar IDs can be retrieved by running GetAllCalendars or SearchCalendarsByName.)
        */
        this.set_CalendarID = function(value) {
            this.setInput("CalendarID", value);
        }
        ...
        */
        ...
        /*
        Set the value of the MaxResults input for this Choreo. ((optional, integer) Maximum number of events returned on one result page.)
        */
        this.set_MaxResults = function(value) {
            this.setInput("MaxResults", value);
        }
...
var GetEventInputSet = function() {
    GetEventInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the CalendarID input for this Choreo. ((required, string) The unique ID for the calendar with the event to retrieve. Note that calendar IDs can be retrieved by running GetAllCalendars or SearchCalendarsByName.)
        */
        this.set_CalendarID = function(value) {
            this.setInput("CalendarID", value);
        }
...
var GetNextEventInputSet = function() {
    GetNextEventInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the CalendarID input for this Choreo. ((required, string) The unique ID for the calendar with the next event to retrieve. Note that calendar IDs can be retrieved by running GetAllCalendars or SearchCalendarsByName.)
        */
        this.set_CalendarID = function(value) {
            this.setInput("CalendarID", value);
        }
...
var GetNextEventResultSet = function(resultStream) {
    GetNextEventResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "BeginTime" output from this Choreo execution. ((date) The start time of the event.)
        */
        this.get_BeginTime = function() {
            return this.getResult("BeginTime");
        }
        /*
        Retrieve the value for the "EndTime" output from this Choreo execution. ((date) The end time of the event.)
        */
        this.get_EndTime = function() {
            return this.getResult("EndTime");
        }
        /*
        Retrieve the value for the "NewAccessToken" output from this Choreo execution. ((string) Contains a new AccessToken when the RefreshToken is provided.)
        */
        ...
        /*
        Retrieve the value for the "Summary" output from this Choreo execution. ((string) The event summary.)
        */
...
var SearchCalendarsByNameInputSet = function() {
    SearchCalendarsByNameInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the MaxResults input for this Choreo. ((optional, integer) The maximum number of calendars to search by name. The default is 15.)
        */
        this.set_MaxResults = function(value) {
            this.setInput("MaxResults", value);
        }
