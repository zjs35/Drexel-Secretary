...
var FinalizeOAuthInputSet = function() {
    FinalizeOAuthInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Resource input for this Choreo. ((conditional, string) The App ID URI of the web API (secured resource). See Choreo notes for details. This can be left blank when using the Excel API.)
        */
...
var InitializeOAuthInputSet = function() {
    InitializeOAuthInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Resource input for this Choreo. ((conditional, string) The App ID URI of the web API (secured resource). See Choreo notes for details. Used for PowerBI only.)
        */
        this.set_Resource = function(value) {
            this.setInput("Resource", value);
        }
        ...
        /*
        Set the value of the Scope input for this Choreo. ((conditional, string) A space-delimited list of the permissions that the user must accept e.g. Files.ReadWrite. Used for Excel only.)
        */
