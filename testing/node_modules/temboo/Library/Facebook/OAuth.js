...
var InitializeOAuthInputSet = function() {
    InitializeOAuthInputSet.super_.call(this);
        ...
        */
        this.set_AuthType = function(value) {
            this.setInput("AuthType", value);
        }
        ...
        */
        ...
        /*
        Set the value of the Scope input for this Choreo. ((conditional, string) A comma-separated list of permissions to request access for (e.g.,  publish_actions). For more information see Choreo notes.)
        */
