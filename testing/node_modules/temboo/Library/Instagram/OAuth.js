...
var InitializeOAuthInputSet = function() {
    InitializeOAuthInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Scope input for this Choreo. ((conditional, string) The scope of the access you're requesting from the user. Valid values are: basic, public_content, follower_list, comments, relationships, and likes. Multiple scope values should separated by spaces.)
        */
