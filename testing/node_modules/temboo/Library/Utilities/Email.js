...
var SendEmailInputSet = function() {
    SendEmailInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Port input for this Choreo. ((required, integer) Specify the port number (e.g., 25, 465, 587).)
        */
        ...
        */
        ...
        /*
        Set the value of the UseSSL input for this Choreo. ((optional, boolean) Set to 1 to connect over SSL. Set to 0 for no SSL or to enable TLS. Defaults to 1.)
        */
